<nav class="navigation">
    ...
    <div id="headBlock">
        <div class="headLogo">
            <a href="/"><img id="logo" src="<?= asset('images/HIFF_logo.png') ?>" alt="HIFF logo"
                    class="HIFF logo"></a>
        ...
        <div class="headContent">
            ...
            <ul class="headLinks fw-semibold">
                <li class="headList"><a @if (isset($actif) && $actif == 'homepage') class="actif" @endif href="/">Home</a>
                </li>
                <li class="headList">
                ...
                <li class="headList"><a @if (isset($actif) && $actif == 'news') class="actif" @endif href="/news">News</a>
                </li>
